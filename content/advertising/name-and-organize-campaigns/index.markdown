...
Campaigns sort alphabetically in AdWords, so it's helpful to take a look at the rules. A couple of things to point out - Nonalphabetical characters precede alphabetical characters. That is, !Google and @Google sort before Google. - Capital letters precede lowercase letters. That is, Google comes before google. - Variables to consider - Here are some possible variables you can consider including in your name:
